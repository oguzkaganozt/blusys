...
```bash
blusys host-build examples/quickstart/handheld_starter
# → examples/quickstart/handheld_starter/build-host/handheld_starter_host
blusys build examples/quickstart/handheld_starter esp32
```
