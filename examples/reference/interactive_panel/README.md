...
Device builds pick **ILI9341** or **ILI9488** from the Blusys framework display menu; host SDL matches via `BLUSYS_DASHBOARD_HOST_DISPLAY_PROFILE`. This is separate from the canonical ST7735 **controller** path used by the interactive controller quickstart.
