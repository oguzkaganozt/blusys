...
[[nodiscard]] inline view::shell_config auto_shell(const device_profile &prof, const char *title)
{
...
[[nodiscard]] inline view::shell_config auto_shell_adaptive(const device_profile &prof,
                                                            const char           *title)
{
    view::shell_config c = auto_shell(prof, title);
