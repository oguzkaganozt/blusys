...
#ifdef BLUSYS_FRAMEWORK_HAS_UI
inline ::blusys::app::host_profile interactive_host_window_profile(const char *window_title = "Pulse Controller")
{
    ::blusys::app::host_profile hp{};
#if defined(BLUSYS_IC_HOST_DISPLAY_PROFILE) && (BLUSYS_IC_HOST_DISPLAY_PROFILE == 1)
    hp.hor_res = 320;
    hp.ver_res = 240;
#else
...
inline view::shell_config interactive_shell_config_for_profile(const device_profile &prof)
{
