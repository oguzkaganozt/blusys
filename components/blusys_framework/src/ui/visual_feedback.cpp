...
const blusys::framework::feedback_timing *timing_for(blusys::framework::feedback_pattern pattern,
                                                       const blusys::framework::feedback_preset &preset)
{
    using blusys::framework::feedback_pattern;
    switch (pattern) {
...
std::uint32_t visual_flash_ms(const blusys::framework::feedback_preset &preset,
                              blusys::framework::feedback_pattern pattern,
                              const theme_tokens &theme)
{
    const blusys::framework::feedback_timing *ft = timing_for(pattern, preset);
