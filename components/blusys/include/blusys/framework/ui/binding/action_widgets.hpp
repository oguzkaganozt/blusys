...
lv_obj_t *button(lv_obj_t *parent,
                 ...
                 const Action &action,
                 app_ctx *ctx,
                 blusys::button_variant variant = blusys::button_variant::primary,
                 bool disabled = false)
{
    ...
    lv_obj_t *widget = blusys::button_create(parent, {
        .label    = label,
        .variant  = variant,
                 ...
                 bool disabled = false)
{
    ...
    lv_obj_t *widget = blusys::toggle_create(parent, {
        .initial   = initial,
                 ...
                 bool disabled = false)
{
    ...
    lv_obj_t *widget = blusys::slider_create(parent, {
        .min       = min,
        .max       = max,
        .initial   = initial,
...
{
    return blusys::label_create(parent, {
        .text = text,
        .font = font != nullptr ? font : blusys::theme().font_body,
    });
}
...
{
    return blusys::divider_create(parent, {});
}
...
{
    return blusys::row_create(parent, {
        .gap          = (gap >= 0) ? gap : blusys::theme().spacing_sm,
        .padding      = padding,
...
{
    return blusys::col_create(parent, {
        .gap          = (gap >= 0) ? gap : blusys::theme().spacing_sm,
        .padding      = padding,
        .main_place   = main_place,
        .cross_place  = cross_place,
...
inline lv_obj_t *progress(lv_obj_t *parent, int32_t min = 0, int32_t max = 100,
                          ...
                          bool show_pct = false)
{
    return blusys::progress_create(parent, {
        .min      = min,
        .max      = max,
        .initial  = initial,
        .label    = lbl,
...
inline lv_obj_t *level_bar(lv_obj_t *parent, int32_t min = 0, int32_t max = 100,
                           int32_t initial = 0, const char *lbl = nullptr)
{
    return blusys::level_bar_create(parent, {
        .min     = min,
        .max     = max,
        .initial = initial,
        .label   = lbl,
...
inline lv_obj_t *vu_strip(lv_obj_t *parent, std::uint8_t segments = 12,
                          ...
                          blusys::vu_orientation orient = blusys::vu_orientation::vertical)
{
    return blusys::vu_strip_create(parent, {
...
{
    return blusys::icon_label_create(parent, {
        .icon = icon,
        .text = text,
    });
}
...
inline lv_obj_t *status_badge(lv_obj_t *parent, const char *text,
                              blusys::badge_level level = blusys::badge_level::info)
{
    return blusys::status_badge_create(parent, {
        .text  = text,
        .level = level,
    });
}
...
{
    return blusys::key_value_create(parent, {
        .key   = key,
        .value = value,
    });
}
...
{
    return blusys::card_create(parent, {
        .title   = card_title,
        .padding = padding,
    });
}
...
{
    return blusys::gauge_create(parent, {
        .min     = min,
        .max     = max,
        .initial = initial,
        .unit    = unit,
...
inline lv_obj_t *chart(lv_obj_t *parent,
                       blusys::chart_type type = blusys::chart_type::line,
                       int32_t point_count = 20,
                       int32_t y_min = 0, int32_t y_max = 100)
{
    return blusys::chart_create(parent, {
        .type        = type,
...
lv_obj_t *list(lv_obj_t *parent,
               const blusys::list_item *items, int32_t item_count,
               ...
               bool disabled = false)
{
    ...
    lv_obj_t *widget = blusys::list_create(parent, {
        .items      = items,
                   ...
                   bool disabled = false)
{
    ...
    lv_obj_t *widget = blusys::dropdown_create(parent, {
        .options      = options,
...
lv_obj_t *tabs(lv_obj_t *parent,
               const blusys::tab_item *items, int32_t item_count,
               int32_t initial,
               Action (*maker)(std::int32_t index),
               app_ctx *ctx)
{
    ...
    lv_obj_t *widget = blusys::tabs_create(parent, {
        .items      = items,
        .item_count = item_count,
        .initial    = initial,
               ...
               bool disabled = false)
{
    ...
    lv_obj_t *widget = blusys::knob_create(parent, {
        .min       = min,
        .max       = max,
        .initial   = initial,
        .on_change = +[](std::int32_t new_value, void *user_data) {
...
lv_obj_t *data_table(lv_obj_t *parent,
                     const blusys::table_column *columns, int32_t col_count,
                     int32_t row_count,
                     ...
                     app_ctx *ctx)
{
    ...
    lv_obj_t *widget = blusys::data_table_create(parent, {
        .columns       = columns,
        .col_count     = col_count,
        .row_count     = row_count,
                      ...
                      bool disabled = false)
{
    ...
    lv_obj_t *widget = blusys::input_field_create(parent, {
