...
!!! tip "Task Guide"
    For a step-by-step walkthrough, see [USB Device Basics](../guides/usb-device-basic.md).
...
!!! note "Managed component dependency"
    Add `espressif/esp_tinyusb: "~0.14.0"` to your project's `main/idf_component.yml`. See `examples/usb_device_basic/main/idf_component.yml` as a reference.
