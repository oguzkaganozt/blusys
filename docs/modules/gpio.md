...
!!! tip "Task Guide"
    For a step-by-step walkthrough, see [Basic GPIO IO](../guides/gpio-basic.md).
...
See `examples/gpio_basic/` for input/output usage.
See `examples/gpio_interrupt/` for ISR callback usage.
