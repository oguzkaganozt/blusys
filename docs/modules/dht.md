...
!!! tip "Task Guide"
    See [DHT Basic](../guides/dht-basic.md) for wiring, a minimal example, and common mistakes.
...
[`examples/dht_basic/`](https://github.com/oguzkaganozt/blusys/tree/main/examples/dht_basic) — reads temperature and humidity 10 times at 3-second intervals.
