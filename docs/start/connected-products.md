...
For locked state/action scope, follow the edge node and gateway quickstarts’ `core/` reducers and the connectivity expectations described in `README.md` (**Product foundations**) and the capability docs.
