...
-   :material-cog:{ .lg .middle } **System**
    ...
    [:octicons-arrow-right-24: System Info](system-info.md) · [NVS](nvs-basic.md) · [Sleep](sleep-basic.md) · [Watchdog](wdt-basic.md)

-   :material-wifi:{ .lg .middle } **Networking**

    ---

    WiFi, HTTP, MQTT, OTA updates, SNTP time sync, and mDNS discovery.

    [:octicons-arrow-right-24: WiFi](wifi-connect.md) · [HTTP](http-basic.md) · [MQTT](mqtt-basic.md) · [OTA](ota-basic.md)
