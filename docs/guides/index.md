...
-   :material-chip:{ .lg .middle } **Device**
    ...
    [:octicons-arrow-right-24: System Info](system-info.md) · [Sleep](sleep-basic.md) · [Watchdog](wdt-basic.md) · [Temperature](temp-sensor-basic.md) · [eFuse](efuse-basic.md) · [ULP GPIO Watch](ulp-gpio-watch.md) · [USB Host](usb-host-basic.md) · [USB Device](usb-device-basic.md)
