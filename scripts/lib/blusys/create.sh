...
cmd_create() {
    ...
    for f in CMakeLists.txt README.md sdkconfig.defaults sdkconfig.qemu blusys.project.yml main/CMakeLists.txt main/idf_component.yml main/app_main.cpp main/ui/CMakeLists.txt main/ui/app_ui.cpp main/core/app_logic.hpp main/core/app_logic.cpp main/ui/app_ui.hpp main/ui/README.md main/platform/app_main.cpp host/CMakeLists.txt; do
